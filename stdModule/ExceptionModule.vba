...
Public Sub CreateMsgDict()
    ...
    With msgIdDict
        .Add "msg-01-001", Array("Do you want to update file?", "Information")
        .Add "msg-01-002", Array("Do you want to update directory?", "Information")
        .Add "msg-01-003", Array("Do you want to show SVNLog?", "Information")
